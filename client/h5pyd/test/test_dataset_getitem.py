...
class TestScalarFloat(TestCase):
    ...
    def setUp(self):
        TestCase.setUp(self)
        filename = "dataset_testscalarflot." + self.base_domain
        self.f = h5py.File(filename, 'w')
...
class Test1DZeroFloat(TestCase):
    ...
    def setUp(self):
        TestCase.setUp(self)
        filename = "dataset_test1dzerofloat." + self.base_domain
        self.f = h5pyd.File(filename, 'w')
...
class Test1DFloat(TestCase):
    ...
    def setUp(self):
        TestCase.setUp(self)
        filename = "dataset_test1dfloat." + self.base_domain
        self.f = h5pyd.File(filename, 'w')
...
class Test2DZeroFloat(TestCase):
    ...
    def setUp(self):
        TestCase.setUp(self)
        filename = "dataset_test2dzerofloat." + self.base_domain
        self.f = h5pyd.File(filename, 'w')
